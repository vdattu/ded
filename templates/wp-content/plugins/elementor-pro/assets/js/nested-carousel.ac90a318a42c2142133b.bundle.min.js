            ...
            class NestedCarousel extends elementorModules.frontend.handlers.CarouselBase {
                ...
                getSwiperSettings() {
                    const e = super.getSwiperSettings(),
                        ...
                        r = `.elementor-element-${this.getID()}`;
                    return elementorFrontend.isEditMode() && (delete e.autoplay, e.loop = !1, e.noSwipingSelector = ".swiper-slide > .e-con .elementor-element"), "yes" === t.arrows && (e.navigation = {
                        prevEl: n ? `${r} .elementor-swiper-button-next` : `${r} .elementor-swiper-button-prev`,
                        nextEl: n ? `${r} .elementor-swiper-button-prev` : `${r} .elementor-swiper-button-next`
                ...
                handleElementHandlers() {
                    ...
                    (0, s.default)(e), this.ranElementHandlers = !0
                }
                wrapSlideContent() {
                    ...
                    this.findElement(`${e.selectors.slidesWrapper} > .e-con`).each((function() {
                        const s = jQuery(this),
                            o = s.closest("div").hasClass(t),
                            l = n.find(`${e.selectors.slidesWrapper} > .${t}:nth-child(${r})`);
                        o || l.append(s), r++
                    }))
                }
