(() => {
    ...
    (() => {
        ...
        function O(e = "", t) {
            ...
            let r = e;
            const n = e.indexOf("?");
            return -1 !== n && (t = Object.assign(A(e), t), r = r.substr(0, n)), r + "?" + f(t)
        }
        ...
        function R(e, t = null) {
            ...
            if (r.match(/^[^\/]+\/$/) && (r = r.replace("/", "")), !t || r.length <= t || !r.match(/([\w|:])*\.(?:jpg|jpeg|gif|png|svg)/)) return r;
            r = r.split("?")[0];
            const n = r.split("/"),
                o = n[n.length - 1];
            ...
            const i = o.lastIndexOf("."),
                ...
                s = u.slice(-3) + "." + c;
            return o.slice(0, t - s.length - 1) + "…" + s
        }
        var S = r(4793),
            v = r.n(S);

        function j(e) {
            return e ? v()(e).replace(/[\s\./]+/g, "-").replace(/[^\p{L}\p{N}_-]+/gu, "").toLowerCase().replace(/-+/g, "-").replace(/(^-+)|(-+$)/g, "") : ""
        }
